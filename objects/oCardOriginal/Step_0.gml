...
{
	played = true
	if originalOwner != 0{flipping = true}
}
...
{	
	...
	if ds_list_size(oDeck.playedList) = 1{angle = 0; newAngle = 0; newX = playedPosX; newY = playedPosY}
...
if hover and leftClickRelease and owner = oDeck.turn and !freshDraw and owner = 0 and oHand.aceDecision = false and !oChatBox.active and shade = 255{
